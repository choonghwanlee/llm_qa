...
The ideal test case should be relevant to the business and explore creative, diverse and difficult edge cases that may make the chatbot fail at achieving its goal.
...
You will be given a user description. Generate just ONE test case (persona, task, goal) that aligns with the user description and chatbot description
'''
